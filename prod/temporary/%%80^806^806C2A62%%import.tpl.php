<?php /* Smarty version 2.6.6, created on 2015-07-02 20:43:07
         compiled from import.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'import.tpl', 94, false),)), $this); ?>
<?php if ($_SESSION['USERID'] > '0' && $_SESSION['STORE'] == '1'): ?>
...
?>
                        <tr class="cat">
                            ...
                            <td class="id" id="<?php echo $this->_tpl_vars['cats'][$this->_sections['i']['index']]['CATID']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['cats'][$this->_sections['i']['index']]['name'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
...
//                $(".modal h1").html("For "+allData[0].cid+"<br>Imported "+currentImprt+" from "+totalImprt);
                ...
                if(failed.length > 0){
                    ...
                    window.location.assign("';  echo $this->_tpl_vars['baseurl'];  echo '/myquestions");
                }
...
//                $(".modal h1").html("For "+allData[0].cid+"<br>Imported "+currentImprt+" from "+totalImprt);
    ...
    <!--    Must <a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/login" class="answer-button">Log in</a>-->
    <div class="clear">	</div>
    <?php endif; ?>