<?php /* Smarty version 2.6.6, created on 2015-04-28 22:06:24
         compiled from administrator/global_header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'administrator/global_header.tpl', 39, false),)), $this); ?>
...
<span class="separator">|</span><a href="logout.php" class="link-logout">Log Out</a>
            ...
            <div class="nav-bar">
            	<ul id="nav">
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="<?php if ($this->_tpl_vars['mainmenu'] == '3'): ?>active<?php endif; ?>   parent level0"> <a href="#"  onclick="return false" class=""><span>Categories</span></a>
                    	<ul >
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="<?php if ($this->_tpl_vars['mainmenu'] == '4'): ?>active<?php endif; ?>   parent level0"> <a href="#"  onclick="return false" class=""><span>Questions</span></a>
                    	<ul >
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="<?php if ($this->_tpl_vars['mainmenu'] == '9'): ?>active<?php endif; ?>   parent level0"> <a href="#"  onclick="return false" class=""><span>Answers</span></a>
                    	<ul >
        ...
        <?php global $config; echo @file_get_contents("http://www.scriptolution.com/updates/aqs/index.php?v=".$config['ver']);  ?>