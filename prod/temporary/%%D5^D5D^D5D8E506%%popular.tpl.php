	...
	<div class="common">
        <div id="new_body">
            <div id="body_900">
                ...
                <div id="body_main">    
                    <div class="title">
                        <h1 class="floatl"><?php echo $this->_tpl_vars['lang49']; ?>
</h1>
...
/popular?filter=all"><?php echo $this->_tpl_vars['lang227']; ?>
</a></li>
											<li <?php if ($this->_tpl_vars['filter'] == 'unanswered'): ?>class="selATags"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/popular?filter=unanswered"><?php echo $this->_tpl_vars['lang246']; ?>
</a></li>
										</ul>
                                        <div class="clear"></div>
                                    </div>
                                ...
                                <div class="answers_area">
                                    <!-- <div class="bb_day bb15"><h3><?php echo $this->_tpl_vars['lang49']; ?>
</h3></div>    -->                                 
                                    <div class="bb_list">
                                        <ul class="list_alist">	
