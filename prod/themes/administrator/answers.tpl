	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                        	...
                                        	<a href="answers.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&pid={$pid}&story={$story}&details={$details}&username={$username}{/if}&delete=1&CID={$results[i].CID}&PID={$results[i].PID}">Delete</a>
                                        </td>
                                	</tr>
                                    {/section}
                                    <tr>
