	<div class="common">
        <div id="new_body">
            <div id="body_900">
                ...
                <div id="body_main">    
                    <div class="title">
                        <h1 class="floatl">{if $parent ne "0"}<a href='{$baseurl}/{$pseo}'>{$pname|stripslashes}</a> | {/if}<a href='{$baseurl}/{$nseo}'>{$name|stripslashes}</a></h1>
                        ...
                        <div class="Center9001RightG">
                            <div class="Center9001Content">
                            	...
                            	<div class="list_area">
									<div class="subsort">
                                    	<ul class="subsort">
                                        	<li {if $filter eq "all"}class="selATags"{/if}><a href="{$baseurl}/{$nseo}?filter=all">{$lang227}</a></li>
											<li {if $filter eq "unanswered"}class="selATags"{/if}><a href="{$baseurl}/{$nseo}?filter=unanswered">{$lang246}</a></li>
										</ul>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                                <div class="answers_area">
                                    ...
                                    <div class="bb_day bb15"><h3>{$name|stripslashes}</h3></div>                                    
                                    <div class="bb_list">
                                        <ul class="list_alist">	
