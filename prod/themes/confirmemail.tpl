            ...
            <div id="body_900">
                ...
                <div id="body_main">
                    ...
                    <div class="Center9001n">
                        ...
                        <form method="post" action="{$baseurl}/confirmemail">
                        <div class="Center9001RightU">
                            <div class="Center9001Content">
                                <div class="login_area">    
                                    <div class="margin20D" style="line-height: 2">
                                        <input type="text" id="code" name="code" value= "{$code|stripslashes}" class="Input_Big" size="25" maxlength="100" />
                                        <br />
                                    </div>
                                    <div class="margin20D">
                                        <div class="floatl"><label><input type="submit" class="button" name="submit" value="{$lang138}" /></label></div>
