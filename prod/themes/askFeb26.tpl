                            ...
                            <div class="Center9001Content">
                                ...
                                <div class="login_area">    
                                    ...
                                    <div class="margin20D" style="line-height: 2; float: left; margin-right: 10px;">
                                    	<strong>Name of what you're looking for:</strong>
                                    	<br>
                                        <input type="text" name="qtitle" id="qtitle" >{$qtitle|stripslashes}</input>
									...
									<div class="margin20D" style="line-height: 2">
                                        ...
                                        <input id="autocomplete" placeholder="" type="text" style="width:475px;height:24px;" class="location">
