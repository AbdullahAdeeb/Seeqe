...
$query="SELECT A.*, B.username, C.name, C.seo FROM posts A, members B, categories C WHERE A.active='1' AND A.open='1' AND A.USERID=B.USERID AND A.category=C.CATID ORDER BY A.viewcount desc limit $showmax";
$showtitle = $lang['49'];
$link   = $config['baseurl']."/rss/popular"; 
