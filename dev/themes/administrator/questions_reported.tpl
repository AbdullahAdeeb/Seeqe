							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                            <a href="questions_edit.php?PID={$results[i].PID}">Edit</a>&nbsp;|&nbsp;
                                            <a href="questions_reported.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&story={$story}&active={$active}{/if}&delete=1&PID={$results[i].PID}">Delete Question</a>&nbsp;|&nbsp;
