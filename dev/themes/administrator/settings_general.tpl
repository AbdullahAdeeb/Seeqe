                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="per_page_home" name="per_page_home" value="{$per_page_home}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="points_ans" name="points_ans" value="{$points_ans}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="points_bans" name="points_bans" value="{$points_bans}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            ...
                                                            <option value="1" {if $verify_asker eq "1"}selected{/if}>Yes</option>
                											<option value="0" {if $verify_asker eq "0"}selected{/if}>No</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="rel_max" name="rel_max" value="{$rel_max}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
