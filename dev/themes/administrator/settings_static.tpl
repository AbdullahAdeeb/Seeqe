                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="title" name="title" value="{$static1.title|stripslashes}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="title" name="title" value="{$static2.title|stripslashes}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="title" name="title" value="{$static3.title|stripslashes}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="title" name="title" value="{$static4.title|stripslashes}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="title" name="title" value="{$static5.title|stripslashes}" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
