...
<body leftmargin="0" topmargin="0" rightmargin="0">
	...
	<div class="common" style="position: fixed; z-index: 1;">
		<div class="topmenu_op">
			...
			<div class="top_layer">
								<span class="thenav">
                                    <a href="{$baseurl}/answer?filter=recent">recently asked</a>
                                    <a href="{$baseurl}/answer?filter=found">Browse</a>  
                                    <a href="{$baseurl}/popular?filter=unanswered">Discover</a>  
                                    <a href="{$baseurl}/ask">ask</a></span>
				<div class="cleartm">
				</div>
			</div>
			 <div class="acctlogin" >
