                                    ...
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class=" a-center last"><?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'get_total_com', 'value' => 'var', 'table' => 'posts_comments')), $this); ?>
</td>
                                        	</tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table cellspacing="0" style="border:0;" id="lastOrdersGrid_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class=" a-center last"><?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'get_total_com', 'value' => 'var', 'table' => 'categories')), $this); ?>
</td>
                                        	</tr>
                                        </tbody>
                                    </table>
