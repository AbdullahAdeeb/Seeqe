<?php /* Smarty version 2.6.6, created on 2015-04-28 22:04:23
         compiled from administrator/questions_validate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'administrator/questions_validate.tpl', 98, false),array('modifier', 'truncate', 'administrator/questions_validate.tpl', 110, false),array('modifier', 'date_format', 'administrator/questions_validate.tpl', 112, false),)), $this); ?>
                                ...
                                <div id="isoft_group_2_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Validate Questions</h4>
 ...
 Questions
                        ...
                        <div class="grid">
							<div class="hor-scroll">
	    	    	        	...
	    	    	        	<thead>
	            	                <tr class="headings">
                                        <th ><span class="nobr"><a href="questions_manage.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&details=<?php echo $this->_tpl_vars['details']; ?>
&username=<?php echo $this->_tpl_vars['username']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="details" class="<?php if ($this->_tpl_vars['sortby'] == 'details'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Question</span></a></span></th>
                                        <th ><span class="nobr"><a href="questions_manage.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
">Edit</a>&nbsp;|&nbsp;
                                            <a href="questions_manage.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
unset($_smarty_tpl_vars);
 ?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Questions - Validate Questions</h3>
                            </div>
                            
                            <form action="questions_validate.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
