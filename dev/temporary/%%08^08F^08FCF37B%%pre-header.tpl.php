...
<style media="screen" type="text/css">
    ...
    /*.form-wrapper {    width: 805px;    padding: 5px;    margin: 150px auto 50px auto;    background: #444;    background: rgba(0,0,0,.2);    border-radius: 10px;    box-shadow: 0 1px 1px rgba(0,0,0,.4) inset, 0 1px 0 rgba(255,255,255,.2);}
    *//* Form text input */ /*.form-wrapper input {    width: 330px;    height: 20px;    padding: 10px 5px;    float: left;        font: bold 15px \'lucida sans\', \'trebuchet MS\', \'Tahoma\';    border: 0;    background: #eee;    border-radius: 3px 0 0 3px;	margin-left: 5px;      } 
